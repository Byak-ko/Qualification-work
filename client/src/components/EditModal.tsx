  ...
  const modalContent = (
    <AnimatePresence>
      {isOpen && (
        ...
        >
          <div className="absolute -top-20 -left-20 w-64 h-64 bg-purple-200 rounded-full filter blur-3xl opacity-30 z-0 animate-pulse"></div>
          <div className="absolute bottom-20 -right-20 w-72 h-72 bg-blue-200 rounded-full filter blur-3xl opacity-30 z-0"></div>
          <div className="absolute -bottom-20 left-40 w-60 h-60 bg-pink-200 rounded-full filter blur-3xl opacity-20 z-0"></div>
          ...
          >
            <div
              className="bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto border border-purple-200"
            >
